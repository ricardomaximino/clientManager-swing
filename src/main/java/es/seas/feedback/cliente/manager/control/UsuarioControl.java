...
public class UsuarioControl implements PersonaControl<Usuario> {
     ...
     *
     */
    public UsuarioControl(ServicioPersona<Usuario> serv, Controlable princip, Map<String, Provincia> prov) {
        this();
        this.servicio = serv;
     ...
     */
    @Override
    public void setServicio(ServicioPersona<Usuario> serv) {
        this.servicio = serv;
    }
     ...
     */
    @Override
    public ServicioPersona<Usuario> getServicio() {
        return servicio;
    }
    ...
    public void crearFrameBuscar() {
        ...
        buscarUsuario.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/images/icon.png")));
    ...
    public void buscar(String nombreDelCampo, String valorDelCampo) {
        ...
        switch (listaDeCampos.indexOf(nombreDelCampo.toUpperCase())) {
            ...
            case 6:
                ...
                if (month != null) {
                    crearFrameListaUsuario(servicio.cumpleanerosDelMes(month), view.getString("message_SEARCHING_BIRTHDAY_OF_THE_MONTH") + valorDelCampo.toUpperCase());
                } else {
