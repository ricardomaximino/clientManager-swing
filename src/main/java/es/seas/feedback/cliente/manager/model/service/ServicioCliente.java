...
public class ServicioCliente implements ServicioPersona<Cliente>{
    ...
    public ServicioCliente(PersonaDAO<Cliente> dao){
        this.dao = dao;
    }
     ...
     */
    @Override
    public void setDao(PersonaDAO<Cliente> dao) {
        this.dao = dao;
    }
     ...
     */
    @Override
    public PersonaDAO<Cliente> getDao() {
        return dao;
    }
     ...
     */
    @Override
    public boolean anadirNuevoRegistro(Cliente cliente) {
        return dao.anadirNuevoRegistro(cliente);
    }
     ...
     */
    @Override
    public List<Cliente> cumpleanerosDelMes(Month mes) {
