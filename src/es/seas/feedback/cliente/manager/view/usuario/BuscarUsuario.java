...
public class BuscarUsuario extends javax.swing.JDialog {
     ...
     */
    public BuscarUsuario(java.awt.Frame parent, boolean modal,PersonaUtilidades personaUtilidades) {
        super(parent, modal);
        initComponents();
        this.personaUtilidades = personaUtilidades;
        cmbCamposUsuario.setModel(personaUtilidades.camposPersonaComboModel());        
    }
    ...
    private void initComponents() {
        ...
        cmbCamposUsuario = new javax.swing.JComboBox<>();
        ...
        cmbCamposUsuario.setFont(new java.awt.Font("Bell MT", 1, 18)); // NOI18N
        cmbCamposUsuario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbCamposUsuarioActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(cmbCamposUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 261, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cmbCamposUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void cmbCamposUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbCamposUsuarioActionPerformed
        if(cmbCamposUsuario.getSelectedItem().toString().equals(personaUtilidades.getCamposPersona()[5])||
                cmbCamposUsuario.getSelectedItem().toString().equals(personaUtilidades.getCamposPersona()[4])){
            txtBuscar.setEnabled(false);
        }else{
            txtBuscar.setEnabled(true);
        }
    }//GEN-LAST:event_cmbCamposUsuarioActionPerformed

    public void buscar(){   
        control.buscar(cmbCamposUsuario.getSelectedItem().toString(), txtBuscar.getText());  
    }
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnBuscar;
    private javax.swing.JComboBox<String> cmbCamposUsuario;
